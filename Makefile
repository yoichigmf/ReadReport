...
SOURCES = \
	__init__.py \
	ReadReport.py ReadReport_dialog.py

PLUGINNAME = ReadReport

PY_FILES = \
	__init__.py \
	ReadReport.py ReadReport_dialog.py

UI_FILES = ReadReport_dialog_base.ui
...
QGISDIR=C:\Users\yoichi\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
